...
nnoremap j gj
nnoremap k gk
nmap ms :mksession! workspace.vim :wviminfo! workspace.viminfo
nmap rs :source workspace.vim :rviminfo workspace.viminfo
...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/vundle,~/.vim/bundle/vim-airline,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/bundle/vundle/,~/.vim/bundle/vundle/after,~/.vim/bundle/vim-airline/after
set shiftwidth=2
set shortmess=atI
set showcmd
set showmatch
...
silent only
cd /mnt/Projects/STM32/BOARD_V1.0/timer_event
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +9 USER/timer_event.c
badd +19 USER/timer_event.h
badd +31 USER/led.c
badd +2 USER/led.h
badd +136 PERIPH/inc/stm32f10x_gpio.h
badd +4 USER/main.c
badd +1 USER/SysTick.c
badd +27 USER/stm32f10x_it.c
silent! argdel *
edit USER/main.c
