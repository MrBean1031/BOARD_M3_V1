...
NVIC_INT_CTRL   	EQU     0xE000ED04  ; 中断控制及状态寄存器(ICSR)
NVIC_SYSPRI14    	EQU     0xE000ED22  ; PendSV优先级寄存器
NVIC_PENDSV_PRI 	EQU     0xFF        ; PendSV中断优先级置为最低
NVIC_PENDSVSET  	EQU     0x10000000  ; ICSR[bit28]写1悬起PendSV异常
